...
<%
     String ra = request.getParameter("cat");
     String var = request.getParameter("marks");
...
String query="select * from student_info where high_school and inter>'"+m+"'";
String query1="select * from student_info where high_school and inter<'"+m+"'";
...
%>
                   <tr>
                       <th><%out.print(i+1);%></th>
                       <th><a href="fret1.jsp?roll=<%=rs1.getString("roll")%>"><%=rs1.getString("fname")%> <%=rs1.getString("mname")%> <%=rs1.getString("lname")%></th>
                       <th><%=rs1.getString("branch")%></th>
                       <th><%=rs1.getString("roll")%></th>
                       <th><%=rs1.getString("session")%></th>
                       <th><img src="user.jsp?roll=<%=rs1.getString("roll")%>" style="width:150px; height:150px;"/></th>
                   </tr>
